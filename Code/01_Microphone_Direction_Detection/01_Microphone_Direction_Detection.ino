...
// pin for servo
#define SERVOPIN 5
// number of values to calculate average from
...
int amplitudes1[AVERAGE_COUNT];
int amplitudes2[AVERAGE_COUNT];
int amplitudes3[AVERAGE_COUNT];
int amplitudes4[AVERAGE_COUNT];
int amplitudes5[AVERAGE_COUNT];
...
// method to shift all values of an array 1 index right, meaning arr[len-1] (last value) will be new first value
void shiftDataArray(int arr[],int len) {
  int temp_value = arr[len-1];
